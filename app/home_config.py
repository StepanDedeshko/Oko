...
class ProfileWidget(QWidget):
    def __init__(self, config, logout_callback=None, parent=None):
        ...
        self.otrs_auto_submit_checkbox = QCheckBox("Автоматически нажимать кнопку входа ОТРС после подстановки")
        self.otrs_auto_submit_checkbox.setChecked(duty.get("otrs_auto_submit_login", False))
    ...
    def save(self):
        ...
        duty["otrs_auto_submit_login"] = self.otrs_auto_submit_checkbox.isChecked()
