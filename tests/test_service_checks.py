...
class ServiceChecksLogicTest(unittest.TestCase):
    ...
    def test_duty_mode_source_separates_zabbix_and_service_tasks(self):
        ...
        self.assertIn("Скопировать заметку", duty_source)
        self.assertIn("zabbix_problems", duty_source)
        ...
        self.assertIn("Проверено, перейти к графикам", duty_source)
        self.assertIn("Ошибка: URL не найден", duty_source)
